...
class CRF(nn.Module):
    ...
    """
    This is the class to do CRF, I have already implemented this class, you can use it directly.
    """
    ...
    def inference(self, feats: torch.Tensor) -> torch.Tensor:
        ...
        This is the function to do inference, you can use it to get the best path of the input feats.
    ...
    def forward(self, feats: torch.Tensor, tags: torch.Tensor) -> torch.Tensor:
        ...
        This is the forward function of CRF, you can use it to get the loss of the input feats and tags.
